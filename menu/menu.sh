...
echo -e "${BICyan} │  ${BICyan}[${BIWhite}7${BICyan}] BACKUP   ${BICyan}[${BIYellow}Menu${BICyan}]${NC}"  
echo -e "${BICyan} └─────────────────────────────────────────────────────┘${NC}"
DATE=$(date +'%d %B %Y')
datediff() {
d1=$(date -d "$1" +%s)
...
15) clear ; menu-theme ;;
13) clear ; update ;;
12) clear ; wget https://raw.githubusercontent.com/ataaxd/udp/main/udpcustom/udp-custom.sh && chmod +x udp-custom.sh && ./udp-custom.sh ;;
